  ...
  methods: {
    ...
    getChildren_reg(parent, resolve, refresh = false) {
      ...
      this.$http
        .post(
          URL +
            "/super/admin/api/v1/enterprise_management/get_terminal_regions_and_departs",
          par
        )
        .then(function(res) {
    ...
    getChildren(parent, resolve, refresh = false) {
      ...
      this.$http
        .post(
          URL +
            "/super/admin/api/v1/enterprise_management/list_enterprise_streamservers_by_org_code_from_remote",
          par
        )
        .then(function(res) {
    ...
    servers() {
      ...
      this.$http
        .post(
          URL +
            "/super/admin/api/v1/enterprise_management/list_all_assist_servers",
          Select
        )
        .then(function(res) {
          // _this.reLogin(res.data.code); //提示帐号登陆、
    ...
    functions() {
      ...
      this.$http
        .post(
          URL +
            "/super/admin/api/v1/enterprise_management/list_enterprise_all_functions"
        )
        .then(function(res) {
          // _this.reLogin(res.data.code); //提示帐号登陆、
          if (res.status === 200 && res.data.result == "ok") {
    ...
    getBoxStatusList() {
      ...
      this.$http
        .post(
          URL +
            "/super/admin/api/v1/enterprise_management/list_enterprise_infos",
          userparameter
        )
        .then(function(res) {
          // _this.reLogin(res.data.code); //提示帐号登陆、
    ...
    organization_paths() {
      ...
      if (stringlist1 == "00") {
        ...
        this.$http
          .post(
            URL +
              "/super/admin/api/v1/enterprise_management/list_parent_monitor_resource_organization_paths",
            Select
          )
          .then(function(res) {
            // _this.reLogin(res.data.code); //提示帐号登陆、
