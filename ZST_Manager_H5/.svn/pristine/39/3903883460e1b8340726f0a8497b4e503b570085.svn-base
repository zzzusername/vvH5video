...
export function Postuserlogin(data) {
  return request({
    url: '/sys_super_admin/api/v1/user_management/login',
    method: 'post',
    data: data
  })
}
//  /enterprise_admin/api/v1/enterprise_user_management/login
export function Postuserlogin2(data) {
  return request({
    url: '/enterprise_admin/api/v1/enterprise_user_management/login',
    method: 'post',
    data: data
  })
}
...
export function getPersonalinfo(data) {
  return request({
    url: '/enterprise_admin/api/v1/enterprise_user_management/get_personal_info',
    method: 'post',
    data: data
  })
}
...
export function listEnterprisedeparts(data) {
  return request({
    url: '/enterprise_admin/api/v1/enterprise_user_management/list_enterprise_sub_departs',
    method: 'post',
    data: data
  })
}
// 当前企业所有职称
//  /enterprise_admin/api/v1/enterprise_user_management/list_enterprise_job_titles
export function listEnterpriseJobtitles(data) {
  return request({
    url: '/enterprise_admin/api/v1/enterprise_user_management/list_enterprise_job_titles',
    method: 'post',
    data: data
  })
}
// 当前企业根部门
//  /enterprise_admin/api/v1/enterprise_user_management/get_enterprise_root_depart
export function getEnterpriseRootdepart(data) {
  return request({
    url: '/enterprise_admin/api/v1/enterprise_user_management/get_enterprise_root_depart',
    method: 'post',
    data: data
  })
}
// 查询 子部门
//  /enterprise_admin/api/v1/enterprise_user_management/list_enterprise_sub_departs
...
// 上传企业用户头型
//  /enterprise_admin/api/v1/enterprise_user_management/upload_avatar

export function uploadAvatar(data) {
  return request({
    url: '/enterprise_admin/api/v1/enterprise_user_management/upload_avatar',
    method: 'post',
    data: data
  })
}
// 修改个人信息
//  /enterprise_admin/api/v1/enterprise_user_management/modify_personal_info

export function modifyPersonalinfo(data) {
  return request({
    url: '/enterprise_admin/api/v1/enterprise_user_management/modify_personal_info',
    method: 'post',
    data: data
  })
}
