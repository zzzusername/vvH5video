	...
	<div id="authority" class="mRight">
        ...
        <el-dialog
            ...
            <div class="adminContpop">
                <div class="adminInp">
					<span class="paddingLeft" style="float: left; line-height: 34px;">姓名或手机号：</span>
                    <el-input v-model="adminInpcont" style="width: 200px;"></el-input>
					...
					<el-form ref="perForm" :model="perForm" label-width="20%">
						<div class="formTable" style="margin: 0px;">
							...
							<div class="block" id="areaSelectpopover">
								<el-form-item label="地区：" :rules="[{ required: true, message: ' '}]">
									<el-input
