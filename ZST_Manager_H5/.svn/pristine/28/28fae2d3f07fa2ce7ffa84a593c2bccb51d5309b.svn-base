<template>
  <div class="mRight" id="menuBox">
    ...
    <div id="menuAddModel">
      <el-dialog :close-on-click-modal="false" title="企业列表 - 新增" :visible.sync="dialogTableVisibleadd">
          ...
          <div class="formTable">
            ...
            <div class="block blockUrl">
              <el-form-item label="终端分布图地址" prop="url">
                <el-input v-model="addenterprise.terminal_distribution_map_url" maxlength="300"
                          placeholder="如：http://10.1.24.33:3000/index?user={username}&pwd={password}&area_code={areaCode}&area_name={areaName}&xzjb={xzjb}&access_token=33333333333333333333333333333333"></el-input>
            ...
            <div class="power" @click="closedButton=false">
              ...
              <el-tabs v-model="activeName" @tab-click="tabClick">
                <el-tab-pane :disabled="disabled" label="功能分配" name="first">
                ...
                <el-tab-pane :disabled="disabled" label="流媒体服务器" name="second">
                  <div class="second">
                    ...
                    <div class="serveraddress"> 已添加服务器地址 <span class="empty" @click="serverEliminate('1')">清空</span>
                    </div>
                    <div id="mediatree">
    ...
    <div id="enterpriseEditModel">
      <el-dialog :close-on-click-modal="false" title="企业列表 - 编辑" :visible.sync="dialogTableVisibleedit">
        <el-form :model="editlist" ref="edit" label-width="30%" class="demo-ruleForm">
          <div class="formTable">
            ...
            <div id="showtreebox2" v-show="closedButtonedit">
              <div class="showtreeboxzTree" di="showtreeboxdisplaybox">
                <el-row class="showtreeboxzTreerow">
                  <el-col :span="24">
                    <el-tabs v-model="activeCity" type="card" @tab-click="handleClickCity" witth="300">
                      <el-tab-pane width="80" height="300" label="全国" name="Country">
                        <div>
                      ...
                      <el-tab-pane width="80" id="county" height="300" label="区" name="county" :disabled="icounty">
                        ...
                        <vue-scroll :ops="ops1" ref="vs">
                          <div class="TerminaLeft">
                            ...
                            <ul id="example-1">
                              <li v-for="item in countyList" :key="item.index" @click="getcounty(item)">{{ item.name
                                }}
                              </li>
                            </ul>
            ...
            <div class="block blockUrl">
              <el-form-item label="终端分布图地址" prop="url">
                <el-input v-model="editlist.terminal_distribution_map_url" maxlength="300"
                          placeholder="如：http://10.1.24.33:3000/index?user={username}&pwd={password}&area_code={areaCode}&area_name={areaName}&xzjb={xzjb}&access_token=33333333333333333333333333333333"></el-input>
              ...
              <el-tabs v-model="activeName" @tab-click="tabClick">
                ...
                <el-tab-pane :disabled="disabled" label="流媒体服务器" name="second">
                  <div class="second">
                    ...
                    <div class="serveradd"></div>
                    <div class="serveraddress"> 已添加服务器地址 <span class="empty" @click="serverEliminate('2')">清空</span>
                    </div>
                    <div id="mediatree1">
                      <div class="scrolltree">
                        <vue-scroll :ops="ops1" ref="vs">
      ...
      get_erver() {
        ...
        get_monitor_server(serurl).then(res => {
          if (res.status === 200 && res.data.result == "ok") {
            ...
            this.monitor_server_url = "监控平台地址 :" + res.data.data.ip + ":" + res.data.data.port
          }
...
//            console.log(list)
            var functionslist = [];
            for (var o in list) {
              // console.log(list[o].comment)
              if (list[o].comment != "会议回放" && list[o].comment != "发送直播" && list[o].comment != "收看直播") {
...
//              console.log(res);
      ...
      addMenuInfoList() {
        ...
        if (this.addenterprise.enterprise_name == '') {
          ...
          flag = false;
        } else if (this.addressHtml2 == '请选择') {
          this.$message({
            message: '地区不允许为空',
            type: 'warning'
          });
          flag = false;
        } else if (this.addenterprise.contacts_names == '') {
          this.$message({
            message: '联系人不允许为空',
            type: 'warning'
          });
          flag = false;
        } else if (this.addenterprise.allocated_enterprise_functions.length === 0) {
          this.$message({
            message: '功能分配不允许为空',
            type: 'warning'
          });
...
//            console.log(terminal_regionslist)
      ...
      editMenuInfoList() {
        ...
        if (this.editlist.enterprise_name == '') {
          ...
          flag = false;
        } else if (this.editlist == '请选择') {
          this.$message({
            message: '地区不允许为空',
            type: 'warning'
          });
          flag = false;
        } else if (this.editlist.contacts_names == '') {
          this.$message({
            message: '联系人不允许为空',
            type: 'warning'
          });
          flag = false;
        } else if (this.editlist.allocated_enterprise_functions.length === 0) {
          this.$message({
            message: '功能分配不允许为空',
            type: 'warning'
          });
          flag = false;
        } else if (this.medialistedit.length === 0) {
          this.$message({
            message: '流媒体服务器不允许为空',
            type: 'warning'
          });
...
//                console.log(list)
        ...
        if (node.level >= 1) {
             ...
             if (stringlist1 == '00' && this.is_all == true) {
