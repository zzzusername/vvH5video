  ...
  <div id="eventlist" class="mRight">
    ...
    <el-dialog  title="详情"
      ...
      <div class="block block-inline">
        ...
        <li>
          <span class="liL w20">报警位置</span>
          <span class="liR w80">{{eventDeatiledata.report_location ? eventDeatiledata.report_location : '暂无数据'}}</span>
        </li>
        <li>
...
<style scoped>
  ...
  #eventlist .w20{width: 25%;}
  #eventlist .w80{width: 75%;}
</style>
