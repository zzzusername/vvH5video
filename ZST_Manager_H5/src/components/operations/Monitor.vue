...
<!-- 监控平台 -->
  <div class="mRight" id="MonitorPage">
    ...
    <div id="MonitorPageAddModel">
      <el-dialog :close-on-click-modal="false" title="监控平台 - 新增" :visible.sync="dialogterminaladd">
        <el-form :model="terminaladd" ref="terminaladd" label-width="25%" class="demo-ruleForm">
          <div class="formTable">
            <div class="block">
              <el-form-item
                label="监控平台名称"
            ...
            <div class="block">
             ...
             <div class="block">
              ...
              >
                <el-input v-model="terminaladd.manager_phonenum"  @change="isRealNum"  placeholder="请输入数字手机号" prop="manager_phonenum"  maxlength="11"></el-input>
              </el-form-item>
            </div>
    ...
    <div id="MonitorPageEditModel">
      <el-dialog :close-on-click-modal="false" title="监控平台 - 编辑" :visible.sync="dialogterminaledit">
        <el-form :model="terminaledit" ref="terminaledit" label-width="25%" class="demo-ruleForm">
          <div class="formTable">
       <div class="block">
              <el-form-item
                label="监控平台名称"
            ...
            <div class="block">
             ...
             <div class="block">
              ...
              >
                <el-input v-model="terminaledit.manager_phonenum" @change="isnumder(terminaledit.manager_phonenum)" maxlength="11"></el-input>
              </el-form-item>
            </div>
...
import {
  ...
  get_monitor_server_list,
  get_monitor_server_add,
  get_monitor_server_modify,
  get_monitor_server_get,
  get_monitor_server_delete,
...
export default {
        ...
        .then(() => {
          ...
          get_sterminal_server_sync_data(Syncid)
            .then(function(res) {
              ...
              // if (res.data.error == "synchronizing") {
              //   //  _this.fullscreenLoading = false;
              //   // _this.fullscreenLoading = false;
              //   _this.$message("同步中");
              //   console.log(res);
      ...
      get_monitor_server_and_terminal_server_config(id)
        .then(function(res) {
          ...
          if (res.data.result == "error") {
            ...
            _this.Serverdata.monitor_server = "该监控平台地址无监控资源";
            _this.Serverdata.terminal_server = "该监控平台地址无终端资源";
  ...
  console.log(this.terminaladd);
      ...
      //新增监控平台
      if (flag) {
        get_monitor_server_add(this.terminaladd)
          .then(function(res) {
            if (res.status === 200 && res.data.result == "ok") {
              var response = res;
              _this.$message({
    ...
    deletelist(index) {
      ...
      this.$confirm("是否执行删除操作?", "消息", {
        ...
        .then(() => {
          ...
          console.log(delDate);
          get_monitor_server_delete(delDate)
            .then(function(res) {
              if (res.status === 200 && res.data.result == "ok") {
                _this.$message({
                  message: "删除成功",
 ...
 console.log(this.terminaladd);
      ...
      else if (this.terminaledit.manager_phonenum == ''||this.terminaledit.manager_phonenum.length!=11) {
          this.$message({
            message: '请输入11位手机号',
            type: 'warning'
          });
    ...
    //  this.terminaledit.is_sync_auto=(this.edit_is_sync_auto=="yes")?true:false
      ...
      if (flag) {
        ...
        //编辑监控平台
        get_monitor_server_modify(this.terminaledit)
          .then(function(res) {
            if (res.status === 200 && res.data.result == "ok") {
              var response = res;
              _this.$message({
