          ...
          <div class="formTable">
            <div class="block block-line">
              <el-form-item label="姓名：" :rules="[{ required: true, message: ' '}]">
                <el-input v-model="addForm.realname" maxlength="20"></el-input>
              </el-form-item>
            </div>
            <template v-if="!isShowPhone">
              <div class="block block-line">
                <el-form-item label="手机号：" :rules="[{ required: true, message: ' '}]">
                  <input class="phone_style" v-model="addForm.phonenum" maxlength="11"/>
                </el-form-item>
              </div>
              <div class="block block-line">
                <el-form-item label="警号：" :rules="[{ required: true, message: ' '}]">
                  <input class="phone_style" v-model="addForm.code" maxlength="10"/>
                </el-form-item>
              </div>
              <div class="block block-line">
            ...
            <template v-if="isShowPhone">
              <div class="block block-line">
                <el-form-item label="手机号：">
                  <el-input type='tel' v-model="addForm.phonenum" maxlength="11" :disabled="isDisabled"></el-input>
                </el-form-item>
              </div>
              <div class="block block-line">
                <el-form-item label="警号：">
                  <el-input v-model="addForm.code" maxlength="10" :disabled="isDisabled"></el-input>
                </el-form-item>
              </div>
              <div class="block block-line">
