						...
						>
							...
							<el-table-column prop="" label="预览图片">
                                <template slot-scope="scope">
                                    <img class="tableImg" :src="getCaption(scope.row.image_url)" alt="" style="width:30px;height:30px;">
								</template>
                            </el-table-column>
                ...
                <el-form  ref="edit" label-width="35%" class="demo-ruleForm">
                    <div class="formTable">
						...
						<div class="block upLoad"  id="personal">
							...
							<span id="upImgspan">（1080x640像素，png，jpg格式）</span>
								<div class="Inf-img">
									<div class="imgCont">
						...
						<div class="block">
							<el-form-item label="跳转链接：(建议以http/https开头)"  prop="passworld">
